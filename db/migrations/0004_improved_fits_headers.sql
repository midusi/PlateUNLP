ALTER TABLE `observation` RENAME COLUMN "time_obs" TO "date_org";--> statement-breakpoint
ALTER TABLE `observation` RENAME COLUMN "time_obs_known" TO "date_org_known";--> statement-breakpoint
...
ALTER TABLE `observation` DROP COLUMN `ut_known`;--> statement-breakpoint
...
ALTER TABLE `plate` ADD `datescan_known` integer DEFAULT true NOT NULL;