...
export const observation = sqliteTable(
  "observation",
  {
    ...
    apertureCoefficient: real().notNull().default(0.95), // coeficiente de tamaño de apertura
    ...
    "DATE-ORG": text("date_org").notNull().default(""),
    "DATE-ORG?": integer("date_org_known", { mode: "boolean" }).notNull().default(true),
