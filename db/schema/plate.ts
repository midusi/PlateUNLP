...
export const plate = sqliteTable("plate", {
  ...
  PLATNOTE: text("platnote").notNull().default(""),
  "PLATNOTE?": integer("platnote_known", { mode: "boolean" }).notNull().default(true),
  SCANNER: text("scanner").notNull().default(""),
  "SCANNER?": integer("scanner_known", { mode: "boolean" }).notNull().default(true),
  SCANNOTE: text("scannote").notNull().default(""),
  "SCANNOTE?": integer("scannote_known", { mode: "boolean" }).notNull().default(true),
