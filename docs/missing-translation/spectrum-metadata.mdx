...
|    `HA`    | Local hour angle                                 | [`getHourAngle`](../reference/astronomical/index.md#gethourangle)       | `ST`, `RA`                             | 0–24 h; minutes and seconds between 0 and 60                                        |
| `AIRMASS`  | Airmass of the object at the time of observation | [`getAirmass`](../reference/astronomical/index.md#getairmass)           | `HA`, `DEC`, `OBSERVAT` (latitude)     | Approximately 1 to 3; outside this range, review coordinates and observation datetime |
