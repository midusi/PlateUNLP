  ...
  return (
    <>
      <div className="flex w-full">
        <div className="w-[5%] flex items-center justify-center">{leftButton}</div>
        ...
        <div className="w-[5%] flex items-center justify-center">{rigthButton}</div>
      </div>
      <div className="flex items-center justify-center mt-8 mb-8">{steps[actual].content}</div>
      <div className="flex w-full">
        <div className="w-[5%] flex items-center justify-center">{leftButton}</div>
        <div className="w-[90%] flex items-center justify-center m-4" />
        <div className="w-[5%] flex items-center justify-center">{rigthButton}</div>
    ...
    <>
      ...
      >
        ...
        {(index < processInfo.processingStatus.generalSteps.length ||
          spectrumSelected !== null) && (
          <StatePoint index={index} actualStep={actualStepIndex} state={state} />
        )}
      </span>
      {!showStepName && (
        <Tooltip id={`step-${step.id}-2tooltip`} place="top" delayShow={300} content={step.id} />
      )}
    </>
  )
}
