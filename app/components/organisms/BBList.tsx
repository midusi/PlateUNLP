  ...
  return (
    <Card className="overflow-visible border-slate-200">
      ...
      >
        ...
        <span className="text-sm text-slate-500">{boundingBoxes.length} boxes</span>
      </div>
                ...
                <div id="displayForRows" className="flex flex-col flex-grow min-w-0 gap-2">
                  <div id="displayForCols" className="flex flex-row flex-grow gap-6">
                    <div id="displayForRows" className="flex flex-col flex-grow min-w-0">
                      ...
                      <div
                        id="displayBoundingoxShape"
                        className="flex items-center mt-1 text-xs text-slate-500 gap-2"
                      >
                  ...
                  {selected == box.id && (
                    <div>{children && React.cloneElement(children, { boxId: box.id })}</div>
                  )}
                </div>
              </div>
            )
