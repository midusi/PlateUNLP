  ...
  return (
    <Card className="m-2">
      <CardHeader>
        ...
        <CardDescription>Fill in the details for the reference lamp data.</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="mb-4">
          <MaterialInput />
...
function MaterialInput() {
  const inputId = useId()
  const [material, setMaterial, oneTeoricalSpectrum, setOneTeoricalSpectrum] = useGlobalStore(
    (s) => [s.material, s.setMaterial, s.oneTeoricalSpectrum, s.setOneTeoricalSpectrum],
  )
  ...
  return (
    <div className="flex flex-col gap-2 col-span-2">
      ...
      <div>
        ...
        />
        <label htmlFor="checkbox-display-materials-in-a-single-spectrum" className="cursor-pointer">
