 ...
 */
export function SelectorBBClass({
	box,
	classes,
	setBoundingBoxes,
}: SelectorBBClassProps) {
	/**
	...
	function handleClickInSelector(
	...
	const [selectedClass, setSelectedClass] = useState<BBClassesProps>(
		box.class_info,
	);
	/**
	...
	return (
		<div className="relative">
			...
			>
				...
				/>
				<span id="NameOfTheActualClass" className="max-w-[100px] truncate">
					{selectedClass.name}
				</span>
