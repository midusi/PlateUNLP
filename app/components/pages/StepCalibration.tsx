    ...
    <div className="w-full flex flex-col">
      ...
      >
        <Pane id="P0" size={80} minSize={20} className="bg-slate-100 p-6">
          ...
          <h3 className="text-lg font-serif tracking-tight">Teorical Comparison Lamp</h3>
          ...
          <div className="flex flex-col ">
            ...
            <div>
              <h3 className="text-lg font-serif tracking-tight">Empirical Comparison Lamp 1</h3>
              <EmpiricalSpectrum data={lamp1Spectrum!} color="#0ea5e9" interactable preview />
            </div>

            {/* Grafico espectro calibrado lampara 2 */}
            <div>
              <h3 className="text-lg font-serif tracking-tight">Empirical Comparison Lamp 2</h3>
              <EmpiricalSpectrum data={lamp2Spectrum!} color="#0ea5e9" interactable preview />
            </div>

            {/* Grafico espectro calibrado ciencia */}
            <div>
              <h3 className="text-lg font-serif  tracking-tight">Empirical Science Spectrum</h3>
