...
import { downloadGrayscaleImage } from "~/lib/utils";
...
export const Route = createFileRoute("/_app/observation/$observationId/")({
	...
	loader: async ({ context, params }) => {
		const { imageWidth, imageHeight, ...initialValues } =
		...
		return {
			breadcrumbs: [
				...
				},
				{
					...
					link: {
						to: "/plate/$plateId",
						params: { plateId: initialValues.plate.id },
					},
				},
				{
					...
					link: {
						to: "/plate/$plateId",
						params: { plateId: params.observationId },
					},
				},
