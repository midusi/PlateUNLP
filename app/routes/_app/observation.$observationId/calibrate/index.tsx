...
import {
	...
	inferenceOptions,
} from "./-child-forms/CalibrationSettingsUI";
...
export const Route = createFileRoute(
	...
	loader: async ({ params }) => {
		const [project, plate, initialMetadata, spectrums, calibration] =
			await Promise.all([
				getProjectName({
...
function RouteComponent() {
	...
	const [pixelToWavelengthFunction, setPixelToWavelengthFunction] =
		useGlobalStore((s) => [
		...
		<>
			<Card className="mx-auto w-full max-w-6xl px-8">
				<CardContent>
					...
					<CalibrationSettingsUI form={form} />
				</CardContent>
