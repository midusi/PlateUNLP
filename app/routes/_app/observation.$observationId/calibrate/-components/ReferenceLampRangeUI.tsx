		...
		listeners: {
			onChange: ({ formApi }) => {
				if (formApi.state.isValid) {
					...
					setMaterial(
						formApi.state.values.material as "He-Ne-Ar" | "Fe-Ne-Ar" | "Fe-Ne",
					);
					...
					const inferenceFunction = selectedFuntionOption.funct(
						...
						selectedFuntionOption.needDegree
							? formApi.state.values.deegre
							: undefined,
					);
	...
	return (
		<>
			...
			<div className="grid w-full grid-cols-1 gap-4 overflow-hidden md:grid-cols-[1fr_200px] ">
				...
				<div className="md:flex md:gap-2 md:flex-col md:justify-center hidden">
