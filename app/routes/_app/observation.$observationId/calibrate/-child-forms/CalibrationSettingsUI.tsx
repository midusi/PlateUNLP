		...
		return (
			<>
				<div className="grid grid-cols-1 items-center justify-center gap-4 md:grid-cols-2 ">
					<div className="order-1 md:order-none flex items-end">
						...
						<div>
							<Button
								type="button"
								className="w-full bg-white hover:cursor-pointer hover:bg-white shadow-none border-r-0"
					...
					<div className="order-4 md:order-none">
						<form.Subscribe
							selector={(state) => state.values.inferenceFunction}
						>
							{(inferenceFunction) => {
