        ...
        <CardContent>
          <div className="grid grid-cols-3 justify-center content-normal gap-4">
            <form.AppField name="OBJECT">
              {(field) => <field.TextField label="OBJECT" placeholder="Name of the object observed" />}
            </form.AppField>
            <form.AppField name="DATE-OBS">
              {(field) => <field.TextField label="DATE-OBS" placeholder="Date of observation (yyyy-mm-dd)" />}
            </form.AppField>
            ...
            <form.AppField name="MAIN-ID">
              {(field) => <field.TextField label="MAIN-ID" placeholder="Simbad main ID object name" />}
            </form.AppField>
            <form.AppField name="TIME-OBS">
              {(field) => <field.TextField label="TIME-OBS" placeholder="Local time at the start of the observation" />}
            </form.AppField>
            ...
            <form.AppField name="RA2000">
              {(field) => <field.TextField label="RA2000" placeholder="Right ascension ICRS J2000" />}
            </form.AppField>
            ...
            <form.AppField name="EXPTIME">
              {(field) => <field.TextField label="EXPTIME" placeholder="Integration time in seconds" />}
            </form.AppField>

            <form.AppField name="DETECTOR">
              {(field) => <field.TextField label="DETECTOR" placeholder="Instrument for detections" />}
            </form.AppField>
            <form.AppField name="IMAGETYP">
              {(field) => <field.TextField label="IMAGETYP" placeholder="Object, dark, zero, etc" />}
            </form.AppField>
