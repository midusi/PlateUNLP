					...
					<CardContent data-open={false}>
						<div className="grid grid-cols-3 content-normal justify-center gap-4">
							...
							<form.AppField name="OBSERVER">
								{(field) => (
									<field.TextField label="OBSERVER" placeholder="OBSERVER" />
								)}
							</form.AppField>

							<form.AppField name="DIGITALI">
								{(field) => (
									<field.TextField label="DIGITALI" placeholder="DIGITALI" />
								)}
							</form.AppField>
							<form.AppField name="SCANNER">
								{(field) => (
									<field.TextField label="SCANNER" placeholder="Scanner name" />
								)}
							</form.AppField>
							...
							<form.AppField name="DETECTOR">
								{(field) => (
									<field.TextField label="DETECTOR" placeholder="Detector" />
								)}
							</form.AppField>
