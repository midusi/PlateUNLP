  ...
  return (
    <div className="flex w-full overflow-hidden justify-center">
      ...
      <div className="m-4 flex-2 w-[200px]">
        <div className="pb-1"><MinInput /></div>
...
function MinInput() {
  ...
  return (
    <div className="flex flex-col gap-2">
      <Label htmlFor={inputId} className="text-sm font-medium text-gray-700">Min. wavelength</Label>
...
function MaxInput() {
  ...
  return (
    <div className="flex flex-col gap-2">
      <Label htmlFor={inputId} className="text-sm font-medium text-gray-700">Max. wavelength</Label>
      <div className="flex items-center gap-1">
        <Input
          id={inputId}
          type="number"
